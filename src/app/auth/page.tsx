...
export default function AuthPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6 py-12" style={{ background: 'var(--surface)' }}>
      <section
        className="w-full max-w-105 rounded-xl border bg-white px-6 py-8 shadow-sm"
